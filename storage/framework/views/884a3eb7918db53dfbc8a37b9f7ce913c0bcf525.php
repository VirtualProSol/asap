...
<div class="container">
    <div class="column">
        <div class="ui card" style="padding:30px;width:45%;margin:3rem auto">
            <div class="content">
                <form method="POST" action="<?php echo e(route('supplier-register')); ?>" class="ui form">
                    ...
                    <?php else: ?>
                    <h3 style="margin:20px auto"><?php echo e($message ?? 'Supplier Registration'); ?></h3>
                    <?php endif; ?>
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="field">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="name" placeholder="Name" required value="<?php echo e($name ?? ''); ?>">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nya/Downloads/Compressed/copy-car-rental-master/resources/views/auth/supplierregister.blade.php ENDPATH**/ ?>