      ...
      <header>
          <div class="ui secondary menu inverted" style="background:#3E4B96;padding:5px" >
              <div class="ui container">
                  ...
                  <a class="item <?php if($home ?? false): ?> active <?php endif; ?>" href="/supplier/home">Home</a>
                  <a class="item <?php if($vehicles ?? false): ?> active <?php endif; ?>" href="/supplier/cars">My Vehicles</a>
                  <a class="item <?php if($my_reservation ?? false): ?> active <?php endif; ?>" href="/supplier/reservations">My Reservations</a>
...
<?php /**PATH /home/nya/Downloads/Compressed/copy-car-rental-master/resources/views/suppliers/layout.blade.php ENDPATH**/ ?>