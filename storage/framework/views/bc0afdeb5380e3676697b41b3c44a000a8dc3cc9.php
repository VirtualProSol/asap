...
<div class="ui container">
    ...
    <form class="ui form"    method="POST" action="<?php echo e(route('new_car_post')); ?>" enctype="multipart/form-data">
...
<div  style="display: none;" id="firstpart" >
  <h4 class="ui header">Vehicle Information</h4>
    ...
    <label for="image" class=""><?php echo e(__('Front photo')); ?></label>
    ...
    <input type="file"  name="imageUrl" id="uploadFile"   required/>
      ...
      <div class="four wide field">
        ...
        <label for="image" class=""><?php echo e(__('Dashboard photo')); ?></label>
        ...
        <input type="file"  name="imageUrl1" id="uploadFile1"   required/>
          ...
          <div class="four wide field">
            ...
            <label for="image" class=""><?php echo e(__('Back Photo')); ?></label>
  ...
  <label for="image" class=""><?php echo e(__('Interior photo showing seats')); ?></label>
  ...
  <input type="file"  name="imageUrl3" id="uploadFile3"   required/>
    ...
    <div class="four wide field">
      ...
      <label for="image" class=""><?php echo e(__('Your favourite Photo')); ?></label>
  ...
  <a  id="nextclick1"  class="yellow  ui compact button "><?php echo e(__('Next')); ?></a>
  ...
  <div  style="display: none;"  id="secondpart">
    ...
    <div class="field">
      ...
      <div class="four wide field">
        ...
        <label for="image" class=""><?php echo e(__('Registration Book')); ?></label>
      ...
      <div class=" ui fields">
        ...
        <div id="agreement" class="ui input" style="display: none;">
          <div  class="field">
            ...
            <label for="image" class=""><?php echo e(__('Upload Agreement of Sale/Affidavit')); ?></label>
      ...
      <label for="image" class=""><?php echo e(__(' Upload  Fitness Certificate from  VID  or AA')); ?></label>
      ...
      <label for="image" class=""><?php echo e(__('Policy Document')); ?></label>
      ...
      <a  id="nextclick2"  class="yellow  ui compact button "><?php echo e(__('Next')); ?></a>
...
<h5>Banking Details</h5>
  ...
  <button   style="display:none"  id="submit_button" type="submit" class="yellow  ui compact button "><?php echo e(__('Register')); ?></button>


<button    id="placeholder_submit_button" type="submit" class="yellow  ui compact button disabled"><?php echo e(__('Register')); ?></button>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nya/Downloads/Compressed/copy-car-rental-master/resources/views/new_car.blade.php ENDPATH**/ ?>