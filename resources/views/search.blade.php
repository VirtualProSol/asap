    ...
    <div class="ui column">
        <div class="column twelve wide">
                ...
                <div class="card">
                    ...
                    <div class="extra content">
                        <a href="{{'/cars/info/'.$car->id}}">
                                ...
                                <button @if($car->supplier_id != Auth::id()) class="ui button red" @else class="ui button red disabled" @endif  style="width:48%" @click="showModal({{json_encode($car)}})">
                                Reserve
                                </button>
                        </div>
                </div>
            ...
            <h3 style="margin-bottom:30px">No vehicles found...Please try again</h3>
                <button class="ui button red" onclick="parent.history.back()"><i class="ui icon arrow left"></i> Go Back</button>
            </div>
