...
@endif
<a href="cars/info/{{$car->id}}"class="red ui icon button" data-tooltip="View Vehicle" data-position="top left">
  <i class="eye icon"   ></i>
</a>
...
>
 ...
 @foreach ($reservations as $reservation)
        <tr>
          ...
          <td class="left aligned">
                <a  href="/reservation/view/{{$reservation->id}}"class="red ui icon button" data-tooltip="View Reservation" data-position="top left">
                <i class="eye icon"   ></i>
                </a>
