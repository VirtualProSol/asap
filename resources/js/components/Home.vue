        ...
        <div class="ui container">
          <div class="ui card row stackable" style="width:40%;padding:20px">
            <div class="content">
              ...
              <button class="red ui compact button large" style="padding:15px;width:100%" id="search" @click="searchCars()">Find Vehicles</button>
          ...
          <div class="ui four special cards stackable" v-if="cars.length > 0">
            ...
            <div class="extra content">
              <a v-bind:href="'cars/info/'+car.id">
                <button class="ui button icon red right floated" style="width:48%">
                View
                </button>
              </a>
              
                <button :class="{'ui button red' : car.supplier_id != user.id,'ui button red disabled' : car.supplier_id == user.id}"  style="width:48%" @click="$root.showModal(car)">
                Reserve
                </button>
          ...
          <div class="card" v-for="car in searchedCars" v-bind:key="car.id" style="border-radius:0">
            ...
            <div class="content">
              ...
              <div class="column" style="padding:0;margin:0"> 
                <button class="red ui button" style="width:100%;border-radius:0px">Reserve Now</button>
              </div>
          </div>
